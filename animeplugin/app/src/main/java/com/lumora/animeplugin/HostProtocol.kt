...
/**
 * Lumora's plugin wire protocol, copied here by value. A plugin is a separate APK with no shared
 * code, so these must match the host's PluginContract exactly. This plugin declares the
 * `stream_search` capability.
 */
object HostProtocol {
